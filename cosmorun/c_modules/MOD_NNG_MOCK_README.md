# mod_nng_mock - Mock NNG implementation for cosmorun testing

**File**: `c_modules/mod_nng_mock.c`
**Dependencies**:
...
`mod_nng_mock` provides mock nng implementation for cosmorun testing.

## Quick Start

```c
#include "mod_nng_mock.c"
...
```c
// See c_modules/example_nng_mock.c for complete examples
```
...
- Example: `c_modules/example_nng_mock.c` (if available)
