# mod_nng_simple - Simplified NNG implementation for cosmorun

**File**: `c_modules/mod_nng_simple.c`
**Dependencies**:
...
`mod_nng_simple` provides simplified nng implementation for cosmorun.

## Quick Start

```c
#include "mod_nng_simple.c"
...
```c
// See c_modules/example_nng_simple.c for complete examples
```
...
- Example: `c_modules/example_nng_simple.c` (if available)
