# mod_nng_static - Static NNG implementation for cosmorun

**File**: `c_modules/mod_nng_static.c`
**Dependencies**:
...
`mod_nng_static` provides static nng implementation for cosmorun.

## Quick Start

```c
#include "mod_nng_static.c"
...
```c
// See c_modules/example_nng_static.c for complete examples
```
...
- Example: `c_modules/example_nng_static.c` (if available)
