# mod_nng_dl - Dynamic NNG implementation for cosmorun

**File**: `c_modules/mod_nng_dl.c`
**Dependencies**:
...
`mod_nng_dl` provides dynamic nng implementation for cosmorun.

## Quick Start

```c
#include "mod_nng_dl.c"
...
```c
// See c_modules/example_nng_dl.c for complete examples
```
...
- Example: `c_modules/example_nng_dl.c` (if available)
