...
/* Use dlopen/dlsym/dlclose/dlerror which are registered in cosmorun99 runtime */
extern void *dlopen(const char *filename, int flags);
extern void *dlsym(void *handle, const char *symbol);
extern int dlclose(void *handle);
extern char *dlerror(void);

#define cosmo_dlopen dlopen
#define cosmo_dlsym dlsym
#define cosmo_dlclose dlclose
#define cosmo_dlerror dlerror
...
static const char* get_sqlite3_library_name(void) {
  ...
  const char* candidates[] = {
    // Bundled libraries (architecture-specific)
    ...
    // System libraries (standard locations)
    "libsqlite3.so.0",                      // Linux (versioned, most common)
    "libsqlite3.so",                        // Linux (unversioned)
    ...
    "/lib/x86_64-linux-gnu/libsqlite3.so.0",      // Debian/Ubuntu x86_64 alt
    "/lib/aarch64-linux-gnu/libsqlite3.so.0",     // Debian/Ubuntu ARM64 alt
    "/usr/lib64/libsqlite3.so.0",          // RedHat/CentOS x86_64
    "/usr/lib/libsqlite3.so.0",            // Generic Linux
    "libsqlite3.dylib",                    // macOS (system)
    "/usr/lib/libsqlite3.dylib",           // macOS (absolute)
    "/opt/homebrew/lib/libsqlite3.dylib",  // macOS Homebrew ARM64
    "/usr/local/lib/libsqlite3.dylib",     // macOS Homebrew x86_64
    "sqlite3.dll",                         // Windows (system)
    NULL
  };
...
const char* sqlite3_get_version(void) {
  if (!load_sqlite3_symbols()) {
    COSMORUN_ERROR_NULL(COSMORUN_ERR_MODULE_LOAD_FAILED, "Failed to load SQLite3 library");
  }
...
int sqlite3_open_wrapper(const char *filename, sqlite3 **ppDb) {
  if (!load_sqlite3_symbols()) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_LOAD_FAILED, "SQLite3 library not loaded");
    return SQLITE_ERROR;
  }
...
int sqlite3_close_wrapper(sqlite3 *db) {
  if (!sqlite3_close_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 close function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_exec_wrapper(sqlite3 *db, const char *sql,
                        ...
                        void *arg, char **errmsg) {
  if (!sqlite3_exec_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 exec function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_prepare_v2_wrapper(sqlite3 *db, const char *zSql, int nByte,
  ...
  if (!sqlite3_prepare_v2_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 prepare function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_step_wrapper(sqlite3_stmt *pStmt) {
  if (!sqlite3_step_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 step function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_finalize_wrapper(sqlite3_stmt *pStmt) {
  if (!sqlite3_finalize_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 finalize function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_bind_text_wrapper(sqlite3_stmt *pStmt, int idx, const char *val,
                              int n, void(*destructor)(void*)) {
  if (!sqlite3_bind_text_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 bind_text function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_bind_int_wrapper(sqlite3_stmt *pStmt, int idx, int val) {
  if (!sqlite3_bind_int_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 bind_int function not available");
    return SQLITE_ERROR;
  }
...
int sqlite3_bind_double_wrapper(sqlite3_stmt *pStmt, int idx, double val) {
  if (!sqlite3_bind_double_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 bind_double function not available");
    return SQLITE_ERROR;
  }
...
const unsigned char *sqlite3_column_text_wrapper(sqlite3_stmt *pStmt, int iCol) {
  if (!sqlite3_column_text_ptr) {
    COSMORUN_ERROR_NULL(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 column_text function not available");
  }
  return sqlite3_column_text_ptr(pStmt, iCol);
}

int sqlite3_column_int_wrapper(sqlite3_stmt *pStmt, int iCol) {
  if (!sqlite3_column_int_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 column_int function not available");
    return 0;
  }
...
double sqlite3_column_double_wrapper(sqlite3_stmt *pStmt, int iCol) {
  if (!sqlite3_column_double_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 column_double function not available");
    return 0.0;
  }
...
int sqlite3_column_count_wrapper(sqlite3_stmt *pStmt) {
  if (!sqlite3_column_count_ptr) {
    COSMORUN_ERROR(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 column_count function not available");
    return 0;
  }
...
const char *sqlite3_column_name_wrapper(sqlite3_stmt *pStmt, int N) {
  if (!sqlite3_column_name_ptr) {
    COSMORUN_ERROR_NULL(COSMORUN_ERR_MODULE_NOT_LOADED, "SQLite3 column_name function not available");
  }
