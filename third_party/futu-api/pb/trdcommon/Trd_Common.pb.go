...
var file_Trd_Common_proto_rawDesc = []byte{
	...
	0x5f, 0x44, 0x54, 0x43, 0x61, 0x6c, 0x6c, 0x10, 0x03, 0x42, 0x40, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
...
func file_Trd_Common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Trd_Common_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_Trd_Common_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_Trd_Common_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
